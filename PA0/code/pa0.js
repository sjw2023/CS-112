...
function draw() {
  ...
  */
  rotatedDegrees += 0.1
  rotatedDegrees % 360;
  mat4.scale(mvMatrix, mvMatrix, [0.6, 0.6, 0.6]); // sx means scale x axis using sx, similarly for sy and sz
  mat4.translate(mvMatrix, mvMatrix, [0, 0, 0]); // tx means translate x axis for tx, similarly for ty and tz
  mat4.rotateZ(mvMatrix, mvMatrix, rotatedDegrees);
