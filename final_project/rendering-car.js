...
function wheel( mat ){
	drawCylinder( mat, 1,1,32, 0, 0, null, null, null, null, null, null, null, [ 0.08, 0.08, 0.5] );
	drawCylinder( mat, 1,1,32, 1, 1, [	0,		-2.5, 0], degToRad(-90), null, null, [1, 0, 0], null, null, [ 0.08, 0.08, 1.5]);
	drawCylinder( mat, 1,1,32, 1, 1, [	1.5,	-1.5, 0], degToRad(-90), null, null, [1, 1, 0], null, null, [ 0.08, 0.08, 1.5]);
	drawCylinder( mat, 1,1,32, 1, 1, [ 	2, 		0, 		0], null, degToRad(-90), null, null, [0, 1, 0], null, [ 0.08, 0.08, 1.5]);
	drawCylinder( mat, 1,1,32, 1, 1, [ 	0, 		-2, 		0], degToRad(-90), degToRad(45), null, [1, 0, 0], [0,1,0], null, [ 0.08, 0.08, 1.5]);
	drawTorus( mat, 2, 1, 32, 16 ,null , degToRad( 0) ,null ,null ,[1,0,0] ,null ,null , [0.5, 0.5, 1] );
}

function drawCarBody(mat, location, size){
	drawCube( mat, 1, null,    null, null, null, null, null, null, [ 3,   0.5, 1.5] );
  drawCube( mat, 1, [0,1,0], null, null, null, null, null, null, [ 1.2, 0.5, 1.5] );
}
